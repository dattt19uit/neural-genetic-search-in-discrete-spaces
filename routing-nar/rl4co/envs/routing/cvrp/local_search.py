...
match platform.system():
    ...
    case "Darwin":
        suffix = "dylib"
    case "Windows":
        raise NotImplementedError("HGS-CVRP is not supported on Windows.")

HGS_LIBRARY_FILEPATH = os.path.join(hgs_dir, "build", "libhgscvrp." + suffix)
...
def local_search(
    ...
    """
    Improve the solution using local search for CVRP, based on SWAP* from HGS-CVRP.
