...
from rl4co.models.zoo.ngs.policy import NGSNonAutoregressivePolicy
from rl4co.utils.ops import unbatchify


class NGS(REINFORCE):
    """Implements Neural Genetic Search (NGS).
    ...
    def __init__(
        self,
        env: RL4COEnvBase,
        policy: Optional[NGSNonAutoregressivePolicy] = None,
        ...
        **kwargs,
        ...
        if policy is None:
            policy = NGSNonAutoregressivePolicy(
                env_name=env.name,
