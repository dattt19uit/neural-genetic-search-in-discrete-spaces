...
from rl4co.models.zoo.ngs.ga import GA
...
class NGSNonAutoregressivePolicy(NonAutoregressivePolicy):
    """Implememts NGS policy based on :class:`NonAutoregressivePolicy`. We use GFACSEncoder by default.
    ...
    Args:
        ...
        n_population: Number of populations to be used in the NGS algorithm. Can be an integer or dictionary. Defaults to 100.
        n_offspring: Number of offsprings to be used in the NGS algorithm. Can be an integer or dictionary. Defaults to 10.
