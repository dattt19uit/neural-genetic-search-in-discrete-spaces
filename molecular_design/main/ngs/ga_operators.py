...
class GeneticOperatorHandler:
    ...
    def select(self, population_smi, population_scores, novelty=None, rank_coefficient=0.01, replace=False):
        return select_next(population_smi, population_scores, novelty, self.population_size, rank_coefficient, replace=replace)
    ...
    def query(self, query_size, mating_pool, pool, model=None, rank_coefficient=0.01, mutation_rate=None):
        ...
        cross_mating_pool, _ = make_mating_pool(population_smi, population_mol, population_scores, self.population_size, rank_coefficient)
